...
#define STRING_CONFIG_H_AUTHOR "MendelMax 2.0 " __DATE__ " " __TIME__ // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // older used mandelmax 2 defaults.
...
#define ABS_PREHEAT_FAN_SPEED 130   // Insert Value between 0 and 255
